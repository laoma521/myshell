...
/*如输入命令位“ls -l/tmp”，则arglist[0]，a[],arglisit[2]分别为ls,-l,和/tmp*/
...
void do_cmd(int argcount, char arglist[100][256])
{
	...
	int   background = 0; /*标示命令中是否又后台运行标示符*/
	int   status;
	int   i;
	int   fd;
	char* arg[argcount + 1];
	...
	/*flag 大于1，说明命令中含有多个>,<,|符号，本程序是不支持这样的命令的，或者命令格式不对，如"ls -l /tmp >"*/
	if(flag > 1)
	{
		printf("wrong command\n");
		return;
